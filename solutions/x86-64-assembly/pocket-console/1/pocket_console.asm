...
.loop:
    mov rax, qword [rsi + 8*rcx]

    ; compare candidate <= first
    mov rbx, r8
    cmp rax, rbx
    cmovg r8, rax ; if candidate > fisrt, fisrt = candidate
    cmovg rax, rbx ; if candidate > fisrt, candidate = old first

    ; compare candidate <= second
    mov rbx, r9
    cmp rax, rbx
    cmovg r9, rax
    cmovg rax, rbx
