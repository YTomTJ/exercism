public class RemoteControlCar
{
    ...
    {
        if (sponsorNum < this.sponsors.Length) {
...
public class TelemetryClient
{
    ...
    {
        if (!this.car.GetTelemetryData(ref serialNum, out var batteryPercentage, out var distanceDrivenInMeters) || distanceDrivenInMeters <= 0) {
            return "no data";
        }
